...
# Spec review: Node CLI Surface Probe

Assignment ID: T002-spec-reviewer

You are reviewing assignment T002-spec-reviewer: Node CLI Surface Probe
...
- Use scoped recovery after context compaction: `./.cowork-flow/run --context-file .cowork-flow/tasks/05-28-agent-team-subagent-drift-probe/agent-team/assignments/T002-spec-reviewer.context.json resume` restores this assignment scope without loading main-session context.
...
- Run `./.cowork-flow/run --context-file .cowork-flow/tasks/05-28-agent-team-subagent-drift-probe/agent-team/assignments/T002-spec-reviewer.context.json agent-team worker-report --status <approved | changes_requested | blocked | needs_context> --file <payload.json>`.
