...
# Spec review: Documentation Scope Probe

Assignment ID: T001-spec-reviewer

You are reviewing assignment T001-spec-reviewer: Documentation Scope Probe
...
- Role: spec-reviewer
- Recommended agent: spec-reviewer
- Agent type: worker
- Spawn target agent type: worker
- Task: Documentation Scope Probe
...
- Use scoped recovery after context compaction: `./.cowork-flow/run --context-file .cowork-flow/tasks/05-28-agent-team-subagent-drift-probe/agent-team/assignments/T001-spec-reviewer.context.json resume` restores this assignment scope without loading main-session context.
...
- Run `./.cowork-flow/run --context-file .cowork-flow/tasks/05-28-agent-team-subagent-drift-probe/agent-team/assignments/T001-spec-reviewer.context.json agent-team worker-report --status <approved | changes_requested | blocked | needs_context> --file <payload.json>`.
