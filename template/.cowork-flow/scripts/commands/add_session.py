...
Usage:
    ./.cowork-flow/run add-session --title "Title" --commit "hash" --summary "Summary"
    echo "content" | ./.cowork-flow/run add-session --title "Title" --commit "hash"
"""
...
from common.core.developer import ensure_developer
from common.core.config import get_session_commit_message, get_max_journal_lines
