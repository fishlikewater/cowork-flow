"""
Kernel utilities for cowork-flow workflow scripts.

This module provides shared functionality used by other cowork-flow scripts.
"""
...
#
# Any script that imports from kernel will automatically get this fix.
# =============================================================================
...
def configure_encoding() -> None:
    ...
    This is automatically called when importing from kernel,
    but can be called manually for scripts that don't import kernel.
