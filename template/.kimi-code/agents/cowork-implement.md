...
whenToUse: Use when the main session dispatches bounded implementation work that needs runtime context binding.
tools: Read, Write, Edit, Grep, Glob, LS, Bash, Skill
---

You are the `cowork-implement` fixed subagent for Kimi Code.
