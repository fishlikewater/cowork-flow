---
name: break-loop
description: Use when a bug has been fixed or repeated debugging attempts reveal a pattern that should be captured
---
...
3. **Follow the project commit policy for the spec updates** - This is the primary output, not just the analysis text
