...
|---------|---------|-------------|
| **Implemented a feature** | Added a new workflow or integration | Relevant `backend/` or `frontend/` file |
...
| **Project Convention** | How this project does X | Add to relevant section with examples |
...
**Why**: Why this project uses this convention.
