...
| 阶段 | 状态 | 关联任务 / 提交 | 下一动作 |
|---|---|---|---|
| 阶段 0：定位与协议收敛 | ⬜ 未开始 | — | 立项：README 定位改写 + `spec/contracts/context-injection.md` 协议规范化 + 三线一致性债修复 |
| 阶段 1：事实层 API 化 + 注入结构化 | ⬜ 未开始 | — | 依赖阶段 0 |
| 阶段 2：多执行者语义 | ⬜ 未开始 | — | 依赖阶段 1 |
| 阶段 3：协议生态适配 | ⬜ 未开始（观察期） | — | 依赖阶段 2；观察 MCP/AGNTCY |
| 本规划文档落库 | ✅ 完成 | 08-27-direction-doc | — |

**当前结论**：方向已批准，下一个动作 = 阶段 0 立项。
